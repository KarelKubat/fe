...
"\n"
"Usage: fe [-h?vseid -k KEY] [-t TARGET ] command arguments\n"
"   or: fe [-h?vseid -k KEY]  -f FILE\n"
"   or: fe  -V\n"
"Supported flags are:\n"
"  -h, -?    This help\n"
...
"  -d        Debugging mode: fe won't transcrypt anything, but pass through\n"
"            all intercepted libc functions and generate verbose messages.\n"
"            Implies -v.\n"
